        ...
        var container =
          ...
          (menu?.content
            ...
            : `<div class="popover-body">` +
              ...
              menu.content2d +
              `</div> <br/>` +
              `<h5 id="three-dimension">Three Dimensional Shapes (3D)</h5> <div class="text-3d">CLICK TO ADD A 3D SHAPE </div> <div id="popover-body-3d">
...
Tools.getColor = (function color() {
  ...
  status.style.backgroundColor = chooser.value
